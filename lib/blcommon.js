...
module.exports = {
     ...
     * @param {Object}   config   Broker configuration
     * @param {Object}   client   Cloent connection object
     * @param {String}   topic    The topic starting with "/"
     * @param {Function} callback The callback function receiveing the message. Returns the following parameters topic,payload,qos,retain
     */
    MqttSub: function (config, client, topic, callback){
        client.subscribe(config.prependtxt + topic, 2, callback);
    }
